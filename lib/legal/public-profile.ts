...
export const LEGAL_OPERATOR_OGRN =
  env.NEXT_PUBLIC_LEGAL_OPERATOR_OGRN || '000000000000000'

export const LEGAL_OPERATOR_REG_AUTHORITY =
  env.NEXT_PUBLIC_LEGAL_OPERATOR_REG_AUTHORITY || 'Регистрирующий орган не указан'

export const LEGAL_OPERATOR_CLAIMS_ADDRESS =
  env.NEXT_PUBLIC_LEGAL_OPERATOR_CLAIMS_ADDRESS || 'Адрес для претензий не указан'
