    ...
    >
      ...
      <div className="container" style={{ position: 'relative', zIndex: 1 }}>
        <div style={{ maxWidth: 720 }}>
          ...
          >
            Английский под вашу цель — <span className="gradient-text">от экзамена до работы</span>{' '}
    ...
    <section id="usecases" className="section">
      <div className="container">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 20 }}>
          {cases.map((c, i) => (
            <div key={c.title} className={`card fade-in delay-${(i + 1) * 100}`} style={{ padding: '32px 28px' }}>
              <div
                style={{
                  width: 56,
                  height: 56,
  ...
  return (
    <section className="section" style={{ background: 'rgba(255,255,255,0.015)' }}>
      <div className="container">
        ...
        >
          {steps.map((s, i) => (
            <div key={s.n} className={`fade-in delay-${(i + 1) * 100}`} style={{ position: 'relative' }}>
  ...
  return (
    <section id="results" className="section">
      <div className="container">
        ...
        >
          {results.map((r, i) => (
            <div key={i} className="card fade-in" style={{ padding: '28px', transitionDelay: `${i * 0.08}s` }}>
        ...
        <div className="fade-in" style={{ textAlign: 'center' }}>
          <CTAButton size="lg" label="Хочу такой же результат" />
        </div>
      </div>
    </section>
  )
      ...
      <div className="container">
        ...
        >
          ...
          <div>
            ...
            <p className="fade-in delay-200" style={{ fontSize: 16, color: '#A1A1AA', lineHeight: 1.75, marginBottom: 32 }}>
...
function Footer({ legalProfile }: { legalProfile: HomePageLegalProfile }) {
  return (
    <footer
      style={{
...
export function HomePageClient({
  ...
  legalProfile: HomePageLegalProfile
}) {
  useScrollAnimation()
  useScrollDepth()
