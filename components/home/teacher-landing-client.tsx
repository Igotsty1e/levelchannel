...
function Pricing() {
  ...
  const tiers: Tier[] = [
    ...
    },
    {
      ...
      // A2 (2026-05-30) — public self-serve activation. CTA → /teacher/subscription:
      // гость → /login (через /teacher/layout.tsx гейт), залогиненный teacher
      // сразу видит карточки тарифов с CloudPayments виджетом.
