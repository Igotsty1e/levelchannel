  ...
  const tiers: Tier[] = [
    {
      ...
      limit: 'до 1 ученика',
      bullets: [
        'Расписание и карточка ученика',
        '1 тариф и 1 пакет на занятия для пробного знакомства',
        'История уроков',
    ...
    <section id="pricing" className="section" tabIndex={-1}>
      <div className="container">
        <div className="fade-in" style={{ textAlign: 'center', marginBottom: 56 }}>
          ...
          >
            «Стартовый» — навсегда, для одного ученика. «Базовый» — для первых 5. «Расширенный» — когда
            учеников становится больше. Платите только за активных.
          </p>
        </div>
