    ...
    <section className="landing-v3-section" style={{ position: 'relative', overflow: 'hidden' }}>
      <div style={{ maxWidth: 1100, margin: '0 auto', display: 'grid', gap: 56 }}>
        <div style={{ maxWidth: 880, marginInline: 'auto', textAlign: 'center' }}>
          ...
          >
            Часть на карту. Часть наличкой. Часть пакетом за месяц вперёд. И всё это разбросано по переписке, чекам перевода и блокноту. А часть помнишь только ты сам.
          </motion.p>
        </div>
        ...
        >
          ...
          <p style={{ margin: 0, fontSize: 14, color: 'var(--v3-text-muted)', lineHeight: 1.55 }}>
            теряет репетитор, который не ведёт балансы. Так говорят преподаватели, с которыми мы общались.
          </p>
        </motion.div>
      </div>
    </section>
