...
const ASSURANCES = [
  {
    title: 'Любой браузер',
    body: 'Просто открываешь в браузере. Скачивать и устанавливать ничего не нужно.',
  },
  {
    title: 'Данные не на телефоне',
    body: 'Всё лежит у нас на сервере, а не в памяти телефона. Сломался телефон, заходишь с ноута, ничего не пропало.',
  },
  {
