...
const GUARANTEES: Guarantee[] = [
  ...
  {
    n: '04',
    title: 'Аналитика, не реклама',
    body: 'Используем Яндекс.Метрику для аналитики и записи сессий на публичных страницах, чтобы видеть, что улучшать. Рекламных сетей и пикселей нет, данные никому не продаём.',
  },
  {
    n: '05',
  ...
  {
    n: '06',
    title: 'Каждое согласие под защитой',
    body: 'Согласие ученика сохраняется отдельной записью с датой, версией документа, IP и устройством. Позже её нельзя изменить.',
  },
]
        ...
        >
          ...
          <div style={{ display: 'grid', gap: 32 }}>
            <motion.h2 {...reveal} transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }} className="landing-v3-h2 landing-v3-h2--serif">
              Данные твоих учеников <em>остаются твоими.</em>
            </motion.h2>

            <motion.p {...reveal} transition={{ duration: 0.8, delay: 0.1 }} className="landing-v3-lede" style={{ margin: 0 }}>
              Мы не продаём данные и не пускаем их в рекламные сети. А техническую сторону 152-ФЗ берём на себя: серверы в РФ, журналы согласий, бэкапы. Тебе остаётся учить.
            </motion.p>
