      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '56px 24px 80px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <Section num="3" title="Формат оказания услуг">
            ...
            <BulletList items={['образовательной платформы Edvibe, если это требуется для конкретного занятия', 'видеосвязи', 'мессенджеров и электронной почты', 'иных цифровых инструментов']} />
          ...
          <Section num="9" title="Персональные данные">
            ...
            <P>После первичного контакта и оплаты Заказчик может дополнительно сообщить Исполнителю фамилию, имя, отчество, номер телефона и иные данные, необходимые для связи, записи, переноса и оказания услуг, в том числе при общении через Telegram, сервисы электронной почты Google или при использовании Edvibe.</P>
