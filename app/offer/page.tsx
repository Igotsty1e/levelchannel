      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '56px 24px 80px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <Section num="5" title="Порядок оказания услуг">
            ...
            <P style={{ marginTop: 12 }}>Заказчик вправе отменить или перенести занятие, предупредив Исполнителя <strong style={{ color: '#fff' }}>не менее чем за 24 часа</strong> до его начала. Уведомление направляется по электронной почте Исполнителя или по согласованному сторонами каналу связи (мессенджер). При своевременном уведомлении оплата за такое занятие зачитывается в счёт следующего согласованного занятия либо подлежит возврату по правилам §8.</P>
          ...
          <Section num="8" title="Возврат денежных средств">
            ...
            <P style={{ marginTop: 12 }}>При отмене занятия со стороны Исполнителя без согласования альтернативного времени — возврат оплаты за такое занятие производится в полном объёме в срок, установленный для возврата по требованию Заказчика.</P>
