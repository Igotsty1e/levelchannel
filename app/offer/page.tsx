...
// 2026-06-17 audit: было `#E89A90` (опечатка) — заменяем на канонический
// акцент `#E8A890` из --accent-end (globals.css:12).
const ACCENT_COLOR = '#E8A890'
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '56px 24px 80px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <Section num="9" title="Персональные данные">
            ...
            <P>Платёжные данные банковской карты обрабатываются исключительно платёжным провайдером CloudPayments. Подробные условия обработки персональных данных, сроки хранения и перечень используемых сервисов указаны в политике по адресу <Link href="/privacy" style={{ color: ACCENT_COLOR }}>/privacy</Link>. Текст согласия на обработку персональных данных размещён по адресу <Link href={PERSONAL_DATA_CONSENT_PATH} style={{ color: ACCENT_COLOR }}>{PERSONAL_DATA_CONSENT_PATH}</Link>.</P>
          </Section>
