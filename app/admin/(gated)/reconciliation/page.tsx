  ...
  return (
    <div>
      <h1 style={{ fontSize: 22, fontWeight: 600, marginBottom: 8 }}>
        Сверка платежей. Оплачено, но пакет не выдан
      </h1>
      <p
        style={{
          color: 'var(--secondary)',
      ...
      >
        Сюда попадают заказы, по которым деньги пришли, но пакет занятий
        не закрепился за учеником. Пока такой заказ не разрешён, ученик
        не может удалить аккаунт. Три действия на выбор:{' '}
        <b>Повторить выдачу</b> — после устранения причины (например,
        пакет был неактивен) попробовать заново;{' '}
        <b>Привязать к аккаунту</b> — если оплата по ошибке попала на
        чужой аккаунт: переписать получателя и повторить выдачу;{' '}
        <b>Закрыть вручную</b> — если оператор уже разрешил вопрос
        вне системы (вернул деньги через CloudPayments, выдал
        эквивалент тарифом и т.п.). «Закрыть вручную» разблокирует
        удаление аккаунта без выдачи пакета.
      </p>
          ...
          >
            <thead>
              <tr style={{ borderBottom: '1px solid var(--border)' }}>
                ...
                <Th>ID аккаунта в заказе</Th>
                <Th>Причина последней неудачи</Th>
                <Th>Пакет</Th>
                <Th>Действия</Th>
              </tr>
            </thead>
