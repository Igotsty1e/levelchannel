...
- [`lib/security/request.ts`](lib/security/request.ts) - origin checks, invoice id validation, per-IP rate limiting
- [`lib/security/rate-limit.ts`](lib/security/rate-limit.ts) - in-memory limiter
