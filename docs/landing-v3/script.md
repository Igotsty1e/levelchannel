...
- **Body (2 параграфа):**
  ...
  Параграф 1 (актуализировано 2026-06-27, после включения Яндекс.Метрики): `Мы не продаём твои данные и не используем их для рекламы. На публичных страницах сайта работает Яндекс.Метрика для статистики посещаемости; в личном кабинете она не подключается, а содержимое вводимых полей маскируется. Плюс наш собственный счётчик кликов по кнопкам — без имён, без email, без сумм.`
