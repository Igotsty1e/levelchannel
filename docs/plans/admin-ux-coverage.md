...
| **P1** | ~~**Wave PKG-LEARNER-BUY**~~ — **SHIPPED 2026-05-16** (PRs #237, #238, #239, LBL.2 pending). `/cabinet/packages` page + buy CTA. Server-side amount/duration/count/title/expiry from catalog (no operator-supplied amount). User-observed product-owner gap closed. |
