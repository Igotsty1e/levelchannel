...
| 6 | Audit-trail согласий | `account_consents` (0011) | доказать, какую версию документа подписал пользователь | ст.9 152-ФЗ (само согласие = объект ст.7), сам audit — legitimate interest по ст.6 п.7 | <!-- legal-rf: TODO; рекомендация — синхронно со сроком исковой давности по 152-ФЗ --> | <!-- legal-rf: TODO --> |
