...
- Тона голоса: коротко, **на «вы»** ко всем ролям (учителю и ученику), без жаргона. Полная матрица — в `docs/content-style.md §2`.
...
- **К учителю и к ученику — на «вы».** Lower-case. Никогда «ты». Никогда «Вы» с прописной. Источник правды: `docs/content-style.md §2` audience matrix. Этот файл (design-system) ранее говорил «к учителю — ты»; это устаревший contract, и content-style выигрывает по своему `Authority` clause.
