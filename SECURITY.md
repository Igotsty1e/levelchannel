...
| Backup БД | не настроен | ежедневный `pg_dump --no-owner --no-acl --clean --if-exists` в `/var/backups/levelchannel/db-YYYY-MM-DD.sql.gz`, retention 14d, perms 600 + dir 700, restore drill пройден |
