...
- `CRON_TRUSTED_HOST=...` (optional, comma-separated; extra allow-list of non-loopback hostnames permitted through the cron-route Host gate. Defaults to loopback-only.)
